...
android {
    ...
    defaultConfig {
        applicationId = "com.prosimplanat.app"
        // Google Maps + GPS tracking (EXP-16/ADM-07) require Android 21+.
    ...
    buildTypes {
        release {
            // TODO: replace with a real release signing config before shipping to Play Store.
